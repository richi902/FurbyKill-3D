...
#else
	Uint32 flags = SDL_INIT_VIDEO | SDL_INIT_JOYSTICK | SDL_INIT_NOPARACHUTE, scrFlags = SDL_HWSURFACE | SDL_DOUBLEBUF /*| SDL_FULLSCREEN*/;
#endif
...
{
	UPDATE_STATUS("Loading Sounds resources 12...");
	EnemyShoot = LoadSound("sounds/EnemyShoot.ogg");
	UPDATE_STATUS("Loading Sounds resources 13...");
	ClosingDoor = LoadSound("sounds/ClosingDoor.ogg");
	UPDATE_STATUS("Loading Sounds resources 14...");
