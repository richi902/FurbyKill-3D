...
void Game::Input()
{
	...
	if(framework->KeyPressed(SDLK_LSHIFT, false)||framework->GetJButton(0, JOY_BTTN_LB))
	...
	if(framework->KeyPressed(SDLK_LCTRL, false) || framework->ButtonPressed(BUTTON_LEFT)||framework->GetJButton(0, JOY_BTTN_RB))
		Shoot();
